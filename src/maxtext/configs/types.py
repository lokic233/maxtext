...
class MaxTextConfig(
  ...
  def validate_chunk_ag_gmm(self):
    """
    Validates that chunk_ag_gmm is used with supported settings.
    """
    if self.chunk_ag_gmm:
      logger.warning(
          "chunk_ag_gmm is an experimental feature under active optimization. "
          "Please report any issues or feedback to the MaxText team."
      )
