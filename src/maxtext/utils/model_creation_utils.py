  ...
  with mesh:
    if config.load_parameters_path:
      ...
      param_state = sharded_state.filter(
          lambda path, var: not isinstance(var, (nnx.RngState, nnx.Cache, nnx.Intermediate, nnx.NormStat))
      )
      ...
      if (
        ...
        # (transient forward-pass activations), and `nnx.NormStat` (runtime statistics).
